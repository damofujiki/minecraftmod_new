...
public class EntityAIThrowProjectile extends EntityAIBase{
    ...
    public EntityAIThrowProjectile(IRangedAttackMob par1IRangedAttackMob, double par2, int par4, float par5)
    {
        this(par1IRangedAttackMob, par2, par4, par4, par5);
    }

    public EntityAIThrowProjectile(IRangedAttackMob par1IRangedAttackMob, double par2, int par4, int par5, float par6)
    {
