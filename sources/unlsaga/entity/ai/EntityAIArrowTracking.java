...
public class EntityAIArrowTracking extends EntityAIBase
{
    ...
    public EntityAIArrowTracking(IRangedAttackMob par1IRangedAttackMob, double par2, int par4, float par5)
    {
        this(par1IRangedAttackMob, par2, par4, par4, par5);
    }

    public EntityAIArrowTracking(IRangedAttackMob par1IRangedAttackMob, double par2, int par4, int par5, float par6)
    {
    ...
    {
    	Unsaga.debug("Target:",this.entityHost.getAttackTarget(),this.attackTarget);
